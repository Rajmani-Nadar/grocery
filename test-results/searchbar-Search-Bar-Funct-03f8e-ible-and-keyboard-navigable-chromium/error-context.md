...
- Name: searchbar.spec.ts >> Search Bar Functionality >> should be accessible and keyboard navigable
- Location: tests\searchbar.spec.ts:149:7
...
- generic [ref=e1]:
  - generic [ref=e2]:
    - banner [ref=e3]:
      - generic [ref=e5]:
        - link "🛒 Grocery" [active] [ref=e6] [cursor=pointer]:
          - /url: /
        - generic [ref=e8]:
          - textbox "Search products..." [ref=e9]
