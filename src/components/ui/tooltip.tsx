...
export function Tooltip({
  ...
  return (
    ...
    >
      ...
      {isVisible && (
        <div
          className={`absolute ${positionClasses[position]} z-50 px-2 py-1 text-xs font-medium text-white bg-slate-800 dark:bg-slate-200 dark:text-slate-800 rounded whitespace-nowrap pointer-events-none animate-in fade-in duration-200`}
        >
          {content}
